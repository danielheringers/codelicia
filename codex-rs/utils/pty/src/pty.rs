...
///
/// `pty_size` specifies the initial terminal dimensions. When `None`, a wide
/// default of 200x50 is used so that wrapped UIs can send a resize later
/// without premature line wrapping.
pub async fn spawn_process(
    ...
    let size = pty_size.unwrap_or(PtySize {
        rows: 50,
        cols: 200,
        pixel_width: 0,
        pixel_height: 0,
